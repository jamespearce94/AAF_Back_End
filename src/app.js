 ...
 * Configure database
 */
mongoose.connect(process.env.MONGO_URL || 'mongodb://127.0.0.1:27017/todoDB'); // Connects to your MongoDB.  Make sure mongod is running!
...
app.set('view engine', 'html'); // Set our view engine to be Jade (so when we render these views, they are compiled with the Jade compiler)
